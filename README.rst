...
::
  ...
  {% send_to_whatsapp <text_to_message> <object_or_url> <link_text> %}
...
Example::
  ...
  {% send_to_whatsapp "Hello, {{object.title}}. Check it out!" object_or_url "Send Whatsapp" %}
...
* ``django_social_share/templatetags/chama_no_zap_bb.html``.
